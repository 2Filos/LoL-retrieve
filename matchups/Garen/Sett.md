...
VOD
Focus on AAing is noteworthy
Correct use of E is crucial, also frequent trading to deny passive (presumably)
Though of course it needs to be executed correctly - pre lv3

Post lv3 Garen's W is online, now what?
NA - 1 is weird, doesn't look good.

A crucial point is also E into Q and viceversa
For Garen it means you cannot follow up immediately with Q
For you it means if you don't E right he Q onto you and gets a good trade - it's a mexican standoff
Interestingly enough from lolalytics Q start into WE seems best
The Q fair enough, just punch him
I'm confused about the W though? probably there's the margin to W him as he leaves (unless stormsurge)
NA2 is vs CQ Garen though

Generally seems pretty straightforward
You E him as he gets out instead of as a start, like Darius E > leading into a free true damage W
He doesn't W cause he doesn't know when you use it? Makes sense
...
The final variable is flash of course - a flash lead means you dodge Sett's W (he still has his shield)
And of course Sett has to be ready to W off Garen's R
Or W early to avoid QR?

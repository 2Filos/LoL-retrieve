...
function processQuickInput() {
    ...
    if (match) {
        ...
        const isChampA = typeof getChampionKeyByName === 'function' ? getChampionKeyByName(champA_raw) : (typeof CHAMPIONS !== 'undefined' && CHAMPIONS ? CHAMPIONS.find(c => c.name.toLowerCase() === champA_raw.toLowerCase()) : null);
        const isChampB = typeof getChampionKeyByName === 'function' ? getChampionKeyByName(champB_raw) : (typeof CHAMPIONS !== 'undefined' && CHAMPIONS ? CHAMPIONS.find(c => c.name.toLowerCase() === champB_raw.toLowerCase()) : null);
